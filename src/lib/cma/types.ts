...
export type CmaHyperSchemaRestApiEndpointHttpExample = {
  id: string;
  title: string;
  description: string;
  request?: {
...
export type CmaHyperSchemaRestApiEndpointJsExample = {
  id: string;
  title: string;
  description: string;
  request?: {
...
export type CmaHyperSchemaRestApiEndpoint = {
  private?: boolean;
  rel: string;
  title: string;
  description?: string;
  ...
  documentation?: {
    javascript?: {
      description?: string;
      examples: CmaHyperSchemaRestApiEndpointJsExample[];
    };
    http?: {
      description?: string;
      examples: CmaHyperSchemaRestApiEndpointHttpExample[];
    };
  };
...
export type RestApiEntity = JSONSchema & {
  links?: CmaHyperSchemaRestApiEndpoint[];
};
