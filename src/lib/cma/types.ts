...
export type CmaHyperschemaLinkHttpExample = {
	id: string;
	title: string;
	description: string;
	request?: {
...
export type CmaHyperschemaLinkJsExample = {
	id: string;
	title: string;
	description: string;
	request?: {
...
export type CmaHyperschemaLink = {
	private?: boolean;
	rel: string;
	title: string;
	description?: string;
	...
	documentation?: {
		javascript?: {
			description?: string;
			examples: CmaHyperschemaLinkJsExample[];
		};
		http?: {
			description?: string;
			examples: CmaHyperschemaLinkHttpExample[];
		};
	};
